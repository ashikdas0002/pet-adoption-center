...
const displayCategories = (categories) => {
    ...
    categories.forEach((item) => {
        ...
        <button class="categoryBtnStyle_1 gap-2 font-[Lato] mx-auto"> <span><img class="w-[40px] h-[40px]" src=${category_icon}/></span>  <span>${category}</span>  </button>
...
</svg></span> <span>Breed: ${breed === undefined ? 'Not Available' : breed} </span> </p>
...
</svg> </span> <span>Birth: ${dateOfBirth} </span> </p>
            <p class="flex items-center gap-1"><span><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
...
</svg> </span> <span>Gender: ${gender === undefined ? 'Not Available' : gender} </span> </p>
            <p class="flex items-center gap-1"><span> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
...
</svg></span> <span>Price: ${price}$</span> </p>
